...
if USE_TENSORBOARD:
    ...
    Writer = SummaryWriter("../visualization/1201/base")
...
if __name__ == '__main__':
    model_path =  "./data/231210_3600_144578_step_model.pickle"
    dataset_path = "./data/231210_3600_144578_step_dataset.pickle"
