...
if USE_TENSORBOARD:
    ...
    Writer = SummaryWriter("../visualization/1205/ranbase")
...
if __name__ == '__main__':
    model_path = "./data/231210_2600_69888_step_model.pickle"
    dataset_path = "./data/231210_2600_69888_step_dataset.pickle"
