...
def main(player1_model_id,player2_model_id,player1_model_path,player2_model_path,player1_elo,player2_elo,step):
    turn = 0
    enemy_turn = 1
...
if __name__ == '__main__':
    ...
    if len(player1_model) != len(player2_model) :
    ...
    for index in range(0,len(player1_model)):
        ...
        player1_elo,player2_elo,step = main(player1_model_id,player2_model_id,player1_model_path,player2_model_path,player1_elo,player2_elo,step)